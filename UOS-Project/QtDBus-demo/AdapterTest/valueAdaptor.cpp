 ...
 * Command line was: qdbusxml2cpp com.bluesky.test.xml -i server.h -a valueAdaptor
 *
...
{
    // handle method call com.bluesky.test.value.maxValue
    int out0;
...
{
    // handle method call com.bluesky.test.value.minValue
    int out0;
...
{
    // handle method call com.bluesky.test.value.value
    int out0;
